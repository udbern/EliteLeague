          ...
          <div className="flex items-center font-montserrat">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="text-white font-montserrat font-semibold border-white hover:bg-white/10 hover:text-white focus:ring-1 focus:ring-gray-500/30"
                >
                  {selectedSeason.name}
                </Button>
              </DropdownMenuTrigger>
                ...
                {[...seasons].sort((a, b) => {
                  ...
                  >
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs hover:text-white text-gray-500">
